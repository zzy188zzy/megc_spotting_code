...
def redetect(eye_param, eye_param_2,
    ...
    # np.save("pp.npy", pp_list)


if __name__ == "__main__":
    redetect(eye_param=1.4, eye_param_2=1.8,
             eye_param_little=1.4, eye_param_little_2=1.8,
             mouth_param=1.4, mouth_param_2=1.8,
             mouth_param_little=1.4, mouth_param_little_2=1.8,
             nose_param=1.4, nose_param_2=2.1, nms_param=0.2, iou_1=0.5,
             path="csv_files/cas_pred_recall.csv")
